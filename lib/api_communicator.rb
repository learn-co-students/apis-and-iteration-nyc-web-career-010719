...
def get_character_movies_from_api(character_name)
  ...
  films = film_arr.map do |film_url|
     res_str = RestClient.get(film_url)
  ...
  #  and that method will do some nice presentation stuff like
  # puts out a list
  #  of movies by title.

   # Have a play around with the puts with other info about a given film.
end
